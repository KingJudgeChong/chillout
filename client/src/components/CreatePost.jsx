...
useEffect(() => { 
  axios.get("http://localhost:8000/categories", {
    ...
    axios.get(`http://localhost:8000/categories/1/category_types`, {  
    }).then(response => {
      console.log(response.data)
  ...
  const handleCategoryChange = (event) => {
    ...
    axios.get(`http://localhost:8000/categories/${event.target.value}/category_types`, {  
    }).then(response => {
              ...
              <div className="relative w-2/5 h-4/5 max-w-3xl">
                ...
                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full h-full bg-white outline-none focus:outline-none">
                  ...
                  <div className="relative p-6 flex-auto">
                    ...
                    <div>
                      <div className="mb-2 block">
                        <label htmlFor="started_at" value="started_at" >dawda</label>
                      </div>
                      <input
                        className="w-80 border-x-0 border-t-0"
                        id="started_at"
